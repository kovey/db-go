...
type BuilderInterface[T RowInterface] interface {
	...
	Where(column string, op Op, val any) BuilderInterface[T]
	...
	NotBetween(column string, begin, end any) BuilderInterface[T]
	Having(column string, op Op, val any) BuilderInterface[T]
